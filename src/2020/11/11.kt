...
fun main() {
    ...
    println(WaitingArea(readFileLineByLineToText("2020_11.txt").toList()).getOccupiedSeatsUsingAdjacentSeats())

    printDay(2)
    print("Occupied seats after stabilizing waiting area: ")
    println(WaitingArea(readFileLineByLineToText("2020_11.txt").toList()).getOccupiedSeatsUsingVisibleSeats())
}
