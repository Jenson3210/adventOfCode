...
fun main() {
    ...
    println(readFileLineByLineToText("2020_18.txt").map { it.solveWithParentheses(String::solveSimpleMath) }.sum())

    printDay(2)
    print("Weird math result: ")
    println(readFileLineByLineToText("2020_18.txt").map { it.solveWithParentheses(String::solveAdvancedMath) }.sum())
}
