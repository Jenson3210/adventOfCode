...
fun main() {
    ...
    println(Program(readFileLineByLineToText("2020_08.txt").map { operation(it) }.toList()).execute().getResult())

    printDay(2)
    print("Result at the end of the program : ")
    val operations = readFileLineByLineToText("2020_08.txt").map { operation(it) }.toList()
