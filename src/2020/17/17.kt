...
fun main() {
    ...
    println(Cube(readFileLineByLineToText("2020_17.txt").toList(), 6).applyRules(6).countActive())

    printDay(2)
    println("Brute-forcing it :)")
    print("Active particles after 6 runs: ")
    println(HyperCube(readFileLineByLineToText("2020_17.txt").toList(), 6).applyRules(6).countActive())
}
