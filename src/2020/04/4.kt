...
fun main() {
    ...
    println(getValidPasswordCountDayOne(readFile("2020_04.txt"), PassportField.values().filter { !it.key.equals("cid", ignoreCase = true) }))

    printDay(2)
    print("Valid passwords: ")
    println(getValidPasswordCountDayTwo(readFile("2020_04.txt"), PassportField.values().filter { !it.key.equals("cid", ignoreCase = true) }))
}
