...
import util.HexagonalCoordinate
...
fun main() {
    ...
    println(HexagonalFloor().flipTiles(readFileLineByLineToText("2020_24.txt")).blackTiles.size)

    printDay(2)
    print("After 100 days: ")
    println(HexagonalFloor().flipTiles(readFileLineByLineToText("2020_24.txt")).passDays(100).blackTiles.size)
}
