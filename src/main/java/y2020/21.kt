...
fun main() {
    ...
    println(IngredientsList(readFileLineByLineToText(2020, 21)).getIngredientsWithoutAllergensUsageCount())

    printDay(2)
    print("The canonical dangerous ingredient list is: ")
    println(IngredientsList(readFileLineByLineToText(2020, 21)).getCanonicalDangerousIngredientList())
}
