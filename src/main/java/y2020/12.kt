...
fun main() {
    ...
    println(Ship().move(readFileLineByLineToText(2020, 12).toList()).getManhattanDistance())

    printDay(2)
    print("Manhattan distance between starting point and endpoint: ")
    println(Ship().moveUsingWaypoint(readFileLineByLineToText(2020, 12).toList()).getManhattanDistance())
}
