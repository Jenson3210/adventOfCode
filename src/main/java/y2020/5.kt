...
fun main() {
    ...
    println(plane.getSeatIdStream(readFileLineByLineToText(2020, 5)).toList().maxOrNull())

    printDay(2)
    print("Valid passwords: ")
    println(plane.getAllSeatIds().minus(plane.getSeatIdStream(readFileLineByLineToText(2020, 5)).toList()))
}
