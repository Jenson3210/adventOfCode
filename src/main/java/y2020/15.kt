...
fun main() {
    ...
    println(NumbersGame(readFileLineCsvToInt(2020, 15).toList()).play(2020))

    printDay(2)
    print("The 30000000th number spoken is  : ")
    println(NumbersGame(readFileLineCsvToInt(2020, 15).toList()).play(30000000))
}

private class NumbersGame(val inputNumbers: List<Int>) {
